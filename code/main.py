...
reg_clustered_lines = clus.regClustering(slope_clustered_lines, 5, 10 ,gray_sacle_image)
...
util.showImage(cv2.cvtColor(gray_sacle_image, cv2.COLOR_GRAY2BGR), 'Join Line Clustering', reg_clustered_lines, True, 'res3.jpg')